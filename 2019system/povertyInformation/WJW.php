...
$sqlStr = "select * from people where address = '文家湾'";
...
<table class="table table-condensed table-striped table-bordered table-hover"  rules="all" align="center" cellpadding="5">
